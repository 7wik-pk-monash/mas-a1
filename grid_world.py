...
class Agent:
    ...
    def __init__(self, id, pos, loc_a):

        self.id = id
        self.pos = pos

        # indicates if agent has already reached A in a run
        self.reached_a = (pos == loc_a)
...
class GridWorld:
    ...
    def get_np_state_for_agent(self, agent):
        ...
        # state space = agent_x X agent_y X loc_ax X loc_ay X loc_bx X loc_by X reached_a X neighbourhood_state_encoding (2^8 combinations) X 
        pass
...
def init_agents(num_agents, loc_a, loc_b):
    ...
    # for debugging only
    debug_locs = [(0,0), (1,0), (1,1)]

    for i in range(num_agents):

        if i == 0:
            # at least one agent must begin at B
            agents.append( Agent(i+1, loc_b, loc_a) )
            continue
        ...
        agents.append( Agent(i+1, rd_loc, loc_a) )
...
if __name__ == '__main__':
    ...
    # print(gw.attempt_action_for_agent(agents[1], 's'))
    # gw.display()


    # print(gw.attempt_action_for_agent(agents[1], 'n'))
    # gw.display()
